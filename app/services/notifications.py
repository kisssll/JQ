...
TOPIC_MODELS = "models"
#: Одна рекламная тема на всё: акции, конкурсы, подборка вечерних окон.
#: Раньше тема была узкой («вечерние окна»), и под каждую новую затею
#: пришлось бы спрашивать человека заново. Согласие по закону должно быть
#: информированным, но не поштучным — формулировка перечисляет, что придёт.
TOPIC_PROMOS = "promos"

TOPIC_LABELS = {
    TOPIC_BOOKINGS: "Записи (новые и отмены)",
    TOPIC_REMINDERS: "Напоминания о визите",
    TOPIC_PROMOS: "Акции и конкурсы",
...
#: Темы, которые приходят ТОЛЬКО по явному согласию. Акции, конкурсы и
#: подборка вечерних окон — реклама: по ч. 1 ст. 18 закона «О рекламе» её
#: рассылка допускается лишь с предварительного согласия получателя. Включить
#: тему можно только через app/services/ad_consent.py — он пишет согласие в
#: журнал, без которого его не доказать.
OPT_IN_TOPICS = frozenset({TOPIC_PROMOS})
