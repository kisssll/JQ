...
#: Вопрос отправляется один раз. Он НЕЙТРАЛЬНЫЙ: без скидок, окон и ссылок на
#: подборку. Вопрос «хотите получать рекламу?» рекламой не является, а
#: «успейте на −30%, хотите ещё?» — уже является, и мы отправили бы ту самую
#: рекламу без согласия, которую этим модулем прекращаем.
QUESTION_TEXT = (
    "Раньше мы присылали вам подборку свободных вечерних окон в салонах со "
    "скидкой. Такие сообщения — реклама, поэтому без вашего разрешения мы "
    "больше их не отправляем.\n\n"
    "Если хотите получать подборку и дальше — нажмите кнопку ниже. Если нет — "
    "ничего делать не нужно, больше мы об этом не спросим.\n\n"
