...
# (заголовок, текст-заглушка — наполняется по мере того, как продиктуют)
_PLACEHOLDER = "Инструкция появится здесь."
_SITE_INSTRUCTIONS = [
    ("Как записаться на процедуру", _PLACEHOLDER),
    ("Как подать заявку на создание салона", _PLACEHOLDER),
    ("Как стать моделью", _PLACEHOLDER),
    ("Как оставить отзыв о салоне", _PLACEHOLDER),
    ("Как изменить или отменить запись", _PLACEHOLDER),
]
