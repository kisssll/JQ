...
from app.tasks import (
    charge_due_subscriptions, expire_unpaid_salons, finalize_tkassa_verification,
    process_payment_webhook, send_booking_reminder, send_email, send_evening_deals_blast,
    send_sms, send_tg_message,
)
...
class WorkerSettings:
    functions = [
        ...
        finalize_tkassa_verification, charge_due_subscriptions, expire_unpaid_salons,
    ]
    ...
    cron_jobs = [
        ...
        cron(expire_unpaid_salons, hour={6}, minute={30}, run_at_startup=False),
    ]
